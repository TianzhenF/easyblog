        ...
        <el-row>
          <el-col :span="4">
            <el-form-item label="昵称" prop="nickName" label-width="50px">
              <el-input placeholder="请输入昵称" clearable @keyup.enter="loadDataList" v-model="searchformData.nickNameFuzzy">
              </el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="4">
            <el-form-item label="手机号" prop="phone" label-width="80px">
              <el-input placeholder="请输入手机号" clearable @keyup.enter="loadDataList" v-model="searchformData.phoneFuzzy">
              </el-input>
            </el-form-item>
          </el-col>
